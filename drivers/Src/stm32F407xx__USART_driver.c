/*
 * stm32F407xx__USART_driver.c
 *
 *  Created on: 05-Sep-2020
 *      Author: KAMAL CHOPRA
 */

#include"stm32F407xx__USART_driver.h"
 ...
 * 			  	  clock for the given USART peripheral
 *
 ...
 * @return		- None
 *
 * @Note		- here we have to reset all the registers of USART peripheral
 * 				  which are supplied to this function .
 * 				  here we use RCC_APB1RSTR register to reset USART peripheral
 *
 ...
 * @fn      		  - USART_Init
 *
 * @brief             - TO intinalize the USART peripheral
 *
 * @param[in]         - pointer to the USART handle structure
 *
 * @return            - NONE
 *
 * @Note              - NONE
...
/******************************** Configuration of CR1******************************************/
    ...
    //Implement to configure the Word length configuration item
...
/******************************** Configuration of CR2******************************************/
	...
	// to configure the number of stop bits inserted during USART frame transmission
   ...
   //Loop over until "Len" number of bytes are transferred
	for(uint32_t i = 0 ; i < Len; i++)
	{
		...
		if(pUSARTHandle->USART_Config.USART_WordLength  == USART_WORDLEN_9BITS )
		{
			...
			{
				//DOUT , as we are sending 9 bits of data but incrementing buffer by 16bits9
